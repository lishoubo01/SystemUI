...
public class CarrierText extends TextView {
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (IPO_SHUTDOWN.equals(action)) {
                Log.d(TAG, "receive IPO_SHUTDOWN & clear carrier text.");
                setText("") ;
            }
        }
    };
    ...
    protected void updateCarrierText() {
        ...
        /*/ freeme.gouzhouping, 20170915. replace the divider by "|"
        String divider = mCarrierTextExt.customizeCarrierTextDivider(mSeparator.toString());
        /*/
        String divider = mCarrierTextExt.customizeCarrierTextDivider(CARRIER_DIVIDER);
        //*/
        for (int i = 0 ; i < mNumOfPhone ; i++) {
        ...
        //*/ freeme.gouzhouping, 20170915. freemestyle cmcc.
        if (!TextUtils.isEmpty(carrierFinalContent) && carrierFinalContent.indexOf("CMCC") >= 0) {
            carrierFinalContent = carrierFinalContent.replace("CMCC", mContext.getString(R.string.freeme_carrier_cmcc));
            Log.d(TAG, "updateCarrierText() - after replace, carrierFinalContent = " +
                            carrierFinalContent) ;
        }
        //*/
