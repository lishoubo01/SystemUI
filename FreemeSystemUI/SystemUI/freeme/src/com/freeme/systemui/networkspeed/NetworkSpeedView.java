...
public class NetworkSpeedView extends LinearLayout implements NetworkSpeedManagerEx.Callback {
    ...
    private com.freeme.systemui.tint.TintTextView mNetSpeedText;
    ...
    protected void onFinishInflate() {
        mNetSpeedText = (com.freeme.systemui.tint.TintTextView) findViewById(R.id.speed);
    ...
    protected void onAttachedToWindow() {
        ...
        if (mNetSpeedText != null) {
            mNetSpeedText.setColorByTintManager();
        }
