...
public class FreemeAudioProfile extends QSTile<QSTile.BooleanState> {
    ...
    private int mAudioState = R.drawable.freeme_ic_qs_normal_on;
    ...
    public FreemeAudioProfile(Host host) {
        super(host);
    ...
    protected void handleLongClick() {
        mHost.startActivityDismissingKeyguard(kIntent);
    }
    ...
    private void loadAudioprofile() {
        ...
        switch (mode) {
            case AudioManager.RINGER_MODE_NORMAL:
                mAudioState = R.drawable.freeme_ic_qs_normal_on;
                mAudioString = R.string.freeme_normal;
                break;
            case AudioManager.RINGER_MODE_SILENT:
                mAudioState = R.drawable.freeme_ic_qs_silent_on;
                mAudioString = R.string.freeme_silent;
                break;
            case AudioManager.RINGER_MODE_VIBRATE:
                mAudioState = R.drawable.freeme_ic_qs_vibrate_on;
