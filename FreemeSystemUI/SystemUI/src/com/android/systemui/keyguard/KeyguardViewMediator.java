...
public class KeyguardViewMediator extends SystemUI {
    ...
    public void onStartedWakingUp() {
        ...
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            TimeWasteLog.markWakeUpOverTime();
        }
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime onStartedWakingUp: " + (System.currentTimeMillis() - beginTime));
        }
        //*/
    }
    ...
    public void onScreenTurningOn(IKeyguardDrawnCallback callback) {
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime onStartedWakingUp: " + System.currentTimeMillis());
        }
        //*/
    ...
    private void maybeSendUserPresentBroadcast() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime maybeSendUserPresentBroadcast: " + (System.currentTimeMillis() - beginTime));
        }
        //*/
    }
    ...
    private void handleKeyguardDone(boolean authenticated) {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleKeyguardDone: " + (System.currentTimeMillis() - beginTime));
            TimeWasteLog.markTotalTimeFromFingerToUnlock();
            TimeWasteLog.reset();
        }
        //*/
    }
    ...
    private void handleHide() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleHide: " + (System.currentTimeMillis() - beginTime));
        }
        //*/
    }
    ...
    private void handleStartKeyguardExitAnimation(long startTime, long fadeoutDuration) {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleStartKeyguardExitAnimation: " + (System.currentTimeMillis() - beginTime));
        }
        //*/
    }
        ...
        synchronized (KeyguardViewMediator.this) {
            ...
            if (callback != null) {
                if (mWakeAndUnlocking) {
                    ...
                    //*/ freeme.chenming, 20171127. Fp Wake
                    if (TimeWasteLog.DEBUG_TIME_WASTE) {
                        Log.d(TimeWasteLog.FP_LOG_TAG, "handleNotifyScreenTurningOn pending DrawnCallback" +
                    ...
                    //*/ freeme.chenming, 20171127. Fp Wake
                    if (TimeWasteLog.DEBUG_TIME_WASTE) {
                        Log.d(TimeWasteLog.FP_LOG_TAG, "handleNotifyScreenTurningOn notifyDrawn" +
                                "\": " + (System.currentTimeMillis() - beginTime));
                    }
                    //*/
                }
    ...
    private void handleNotifyScreenTurnedOn() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleNotifyScreenTurnedOn: " + (System.currentTimeMillis() - beginTime));
        }
        //*/
    }
