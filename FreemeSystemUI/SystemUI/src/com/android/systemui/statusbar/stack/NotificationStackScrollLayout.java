...
public class NotificationStackScrollLayout extends ViewGroup
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        //*/ freeme.gouzhouping, 20170901. workaround:forbidden scroll notification in edit surface.
        if (((QSContainer)mQsContainer).getQsPanel().isShowingCustomize()) {
    ...
    private void updateBackgroundBounds() {
        ...
        if (mDismissView != null && mDismissView.getVisibility() == View.VISIBLE
                && mPhoneStatusBar.getBarState() != StatusBarState.KEYGUARD
                && mBackgroundBounds.bottom != 0) {
            mBackgroundBounds.bottom += (lastView != null && lastView.getIncreasedPaddingAmount() == 1.0f)
                    ? mIncreasedPaddingBetweenElements :
                    mPaddingBetweenElements;
        }
        //*/
