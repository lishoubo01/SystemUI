...
public class SignalClusterView
    ...
    //*/ freeme.gouzhouping, 20170908. customize signal standard.
    ...
    public void setMobileDataIndicators(IconState statusIcon, IconState qsIcon, int statusType,
        ...
        //*/ freeme.gouzhouping, 20170908. customize signal standard.
        int[] data = new int[]{statusType, getDataActivityInout(activityIn, activityOut)};
    ...
    public void onRtlPropertiesChanged(int layoutDirection) {
        ...
        for (PhoneState state : mPhoneStates) {
            ...
            if (state.mMobileType != null) {
                ...
                //*/ freeme.gouzhouping, 20170908. customize signal standard.
                state.mDataInOut.setImageDrawable(null);
                //*/
    ...
    private void applyIconTint() {
        ...
        /// @}
        /*/ freeme.gouzhouping, 20170908. customize wifi standard.
        applyDarkIntensity(
                StatusBarIconController.getDarkIntensity(mTintArea, mWifi, mDarkIntensity),
                mWifi, mWifiDark);
        /*/
        setTint(mWifi,StatusBarIconController.getTint(mTintArea, mWifi, mIconTint));
        //*/
        applyDarkIntensity(
    ...
    private class PhoneState {
        ...
        public void setViews(ViewGroup root) {
            ...
            //*/ freeme.gouzhouping, 20170908. customize signal standard.
            mDataInOut      = (ImageView) root.findViewById(R.id.freeme_data_inout);
            //*/
        }
        ...
        public boolean apply(boolean isSecondaryIcon) {
            if (mMobileVisible && !mIsAirplaneMode) {
                ...
                if (mLastMobileTypeId != mMobileTypeId) {
                    ...
                    /*/
                    mMobileType.setImageResource(0);
                    //*/
            ...
            //*/ freeme.gouzhouping, 20170908. customize signal standard.
            int currentSubID = -1;
            final SubscriptionInfo sir = SubscriptionManager.from(mContext).getDefaultDataSubscriptionInfo();
            if (sir != null) {
                currentSubID = sir.getSubscriptionId();
            }
            if (currentSubID == mSubId) {
                showDataInout(mDataInOut);
            }
            //*/
            ...
            //*/ freeme.gouzhouping, 20170908. customize signal standard.
            mDataInOut.setVisibility(mMobileTypeId !=0 ? View.VISIBLE : View.GONE);
            //*/
        ...
        public void setIconTint(int tint, float darkIntensity, Rect tintArea) {
            ...
            //*/ freeme.gouzhouping, 21070908. customize signal standard.
            ...
            setTint(mDataInOut, StatusBarIconController.getTint(tintArea, mDataInOut, tint));
            //*/
        }
        ...
        private void hideViewInWfcCase() {
            ...
            mNetworkType.setVisibility(View.GONE);
            //*/ freeme.gouzhouping, 20170908. customize signal standard.
            mDataInOut.setVisibility(View.GONE);
            //*/
            mIsWfcCase = true;
        }
        ...
        private void showViewInWfcCase() {
            if (mIsWfcCase) {
                ...
                mNetworkType.setVisibility(View.VISIBLE);
                //*/ freeme.gouzhouping, 20170908. customize signal standard.
                mDataInOut.setVisibility(View.VISIBLE);
                //*/
                mIsWfcCase = false;
            }
        }
    ...
    //*/ freeme.gouzhouping, 20170908. customize signal standard.
    static final int DATA_ACTIVITY_NONE = R.drawable.freeme_data_signal_not_inout;
    static final int DATA_ACTIVITY_IN = R.drawable.freeme_data_signal_in;
    static final int DATA_ACTIVITY_OUT = R.drawable.freeme_data_signal_out;
    static final int DATA_ACTIVITY_INOUT = R.drawable.freeme_data_signal_inout;

    private int getDataInoutResource(int dataActivity) {
    ...
    private int getDataActivityInout(boolean activityIn, boolean activityOut) {
    ...
    private void showDataInout(ImageView mDataInout) {
        int mobileTypeId = 0;
        int dataActivity = TelephonyManager.DATA_ACTIVITY_NONE;
        ...
        if (0 == mobileTypeId || mBlockMobile) {
            mDataInout.setImageResource(0);
            mDataInout.setVisibility(View.GONE);
        } else {
            mDataInout.setImageResource(isMobileConnected(mContext) ?
                    getDataInoutResource(dataActivity) : 0);
            mDataInout.setVisibility(View.VISIBLE);
        }
    }
    ...
    public boolean isMobileConnected(Context context) {
        if (context != null) {
            ...
            return tele.getDataState() == TelephonyManager.DATA_CONNECTED;
        }
        return false;
    }
    //*/
