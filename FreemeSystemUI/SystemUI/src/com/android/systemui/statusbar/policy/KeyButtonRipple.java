...
public class KeyButtonRipple extends Drawable {
    ...
    private Paint getRipplePaint() {
        ...
        if (TintManager.DEF_TINT_WHITE != TintManager.getInstance().getIconColorByType("navigationBarType")
                || TintManager.getInstance().isFreemeLightStyle()) {
            mRipplePaint.setColor(R.color.freeme_navigation_bar_icon_color_black);
        }
        if (TintManager.getInstance().isLuncherStyle()) {
            mRipplePaint.setColor(R.color.freeme_navigation_bar_icon_luncher_color);
        }
        //*/
