        ...
        if (fd != null) {
            ...
            if (selectedUser != null && selectedUser.getIdentifier() != currentUserId) {
                ...
                return LoaderResult.success(
                        //*/ freeme.biantao, 20170122. Wallpaper.
                        mWallpaperManager.getBitmapAsUser(WallpaperManager.FLAG_LOCK, selectedUser.getIdentifier()));
                        /*/
                ...
                //*/ freeme.biantao, 20170122. Wallpaper.
                return LoaderResult.success(mWallpaperManager.getBitmapAsUser(WallpaperManager.FLAG_LOCK, lockWallpaperUserId));
                /*/
