...
public class StatusBarIconController extends StatusBarIconList implements Tunable {
    ...
    private TintImageView mFreemeBatteryView;
    //*/
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        //*/ freeme.chenming, 20170731. Freeme Battery.
        mFreemeBatteryView = (TintImageView) statusBar.findViewById(R.id.battery_border);
        //*/
    }
    ...
    private void applyIconTint() {
        ...
        //*/ freeme.chenming, 20170731. Freeme Battery.
        TintManager.getInstance().setTintColor(getTint(mTintArea, mFreemeBatteryView, mIconTint));
        //*/
    }
