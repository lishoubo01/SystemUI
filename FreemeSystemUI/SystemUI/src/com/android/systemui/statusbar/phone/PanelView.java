...
public abstract class PanelView extends FrameLayout {
    ...
    private void runPeekAnimation() {
        ...
        mPeekAnimator = ObjectAnimator.ofFloat(this, "expandedHeight", mPeekHeight)
                .setDuration(250);
        /*/
        mPeekAnimator = ObjectAnimator.ofFloat(this, "expandedHeight", mPeekHeight / 4)
                .setDuration(250);
        //*/
    ...
    protected void flingToHeight(float vel, boolean expand, float target,
        ...
        if (expand) {
            ...
            mFlingAnimationUtils.applyDismissing(animator, mExpandedHeight, target, vel,
                    getHeight());
            /*/ freeme.zhongkai.zhu. 20170731. fix NotificatonPanelView disappear without animation
