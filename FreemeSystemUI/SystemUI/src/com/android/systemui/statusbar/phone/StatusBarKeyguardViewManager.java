...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
        ...
        if (mPhoneStatusBar.isInLaunchTransition() ) {
            mPhoneStatusBar.fadeKeyguardAfterLaunchTransition(new Runnable() {
                ...
                public void run() {
                    ...
                    //*/ freeme.zhiwei.zhang, 20170803, BugFix:0016387, reset mKeyguardGoingAway state while fadingaway finish.
    ...
    public void updateStates() {
        ...
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            navBarVisible = navBarVisible && android.provider.Settings.System.getIntForUser(mContext.getContentResolver(),
                    com.freeme.provider.FreemeSettings.System.FREEME_NAVIGATION_BAR_COLLAPSED, 0, android.os.UserHandle.USER_CURRENT) == 0;
        }
        //*/
