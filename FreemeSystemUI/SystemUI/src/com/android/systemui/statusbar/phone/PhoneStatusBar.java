...
//*/ freeme.zhiwei.zhang, 20170911. Navigation.
...
import com.freeme.systemui.battery.FreemeBatteryManager;
//*/
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private FreemeBatteryManager mFreemeBatteryManager;
    //*/

    //*/ freeme.gouzhouping, 20170622. show carrier label.
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        if (ENABLE_LOCKSCREEN_WALLPAPER) {
            ...
            //*/ freeme.zhongkai.zhu. 20170329. bug#6965: a black flash when booting to launcher
            String hasWallpaper = mLockscreenWallpaper.getBitmap() != null ? "1" : "0";
            Settings.System.putString(mContext.getContentResolver(), "lockscreen_wallpaper_ready",  hasWallpaper);
            Log.d(TAG, "set lockscreen_wallpaper_ready = " + hasWallpaper);
            //*/
        }
        ...
        if (container != null) {
            ...
            container.addInflateListener(new InflateListener() {
                ...
                public void onInflated(View v) {
                    ...
                    //*/ freeme.gouzhouping. 20170830. brightness layout
                    mQSPanel.registerBrightnessControllerCallback(true);
                    //*/
                    mQSPanel.setBrightnessMirror(mBrightnessMirrorController);
                    //*/ freeme.gouzhouping, 20171101. data usage.
                    mQSPanel.getQSDataUsageView().setDataUsageController(mNetworkController.getMobileDataController());
                    //*/
                ...
                public void onAllViewsRemoved() {
                    if (mQSPanel != null) {
                        mQSPanel.registerBrightnessControllerCallback(false);
                    }
                }
                //*/
            });
        ...
        //*/ freeme.gouzhouping, 20170622. show carrier label.
        mCarrierLabel = (TextView) mNotificationPanel.findViewById(R.id.notification_panel_carrier_label);
        //*/

        //*/ freeme.gouzhouping, 20170908. customize dismiss view.
        View notificationSetting = mDismissView.findViewById(R.id.notification_settings);
        notificationSetting.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                Log.d(TAG, "click moresettings to start NotificationAppListActivity");
   ...
   /// @}
    ...
    protected void toggleSplitScreenMode(int metricsDockAction, int metricsUndockAction) {
        //*/ freeme.zhiwei.zhang, 20170303. Navigation - RecentKey.
    ...
    private final View.OnLongClickListener mLongPressHomeListener
        ...
        public boolean onLongClick(View v) {
            ...
            //*/ freeme.zhiwei.zhang, 20170911. Navigation - RecentKey.
            if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
                if (mLongPressOnHomeBehavior == LONG_PRESS_HOME_RECENT_SYSTEM_UI) {
                    toggleRecents();
                } else if (mLongPressOnHomeBehavior == LONG_PRESS_HOME_ASSIST){
                    launchFreemeAssistAction();
                }
            } else
            //*/
    ...
    private void prepareNavigationBarView() {
        ...
        //*/ freeme.zhiwei.zhang, 20170911. Navigation.
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            ButtonDispatcher collapsableButton = mNavigationBarView.getCollapsableButton();
            collapsableButton.setOnClickListener(mCollapsableButtonClickListener);
        }
        //*/
    ...
    protected void addNavigationBar() {
        ...
        //*/ freeme.zhiwei.zhang, 20170911. Navigation.
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            updateNavigationBar(Settings.System.getIntForUser(mContext.getContentResolver(),
                    FreemeSettings.System.FREEME_NAVIGATION_BAR_COLLAPSED, 0, UserHandle.USER_CURRENT) == 1);
        }
        //*/
    ...
    private void updateClearAll() {
        boolean showDismissView =
                ...
                //*/ freeme.gouzhouping, 20170908. customize dismiss view.
                !mNotificationData.getActiveNotifications().isEmpty();
                /*/
    ...
    void makeExpandedVisible(boolean force) {
        ...
        //*/ freeme.gouzhouping, 20171101. data usage.
        mQSPanel.getQSDataUsageView().onPanelVisible();
        //*/
    }
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //*/ freeme.zhiwei.zhang, 20170911. Navigation.
                ...
                updateNavigationBar(intent.getBooleanExtra(FreemeIntent.EXTRA_CHANGED_STATUS, false));
            }
            //*/
        }
    };
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        //*/ freeme.chenming, 20170731. Freeme Battery.
        if (mFreemeBatteryManager != null) {
            mFreemeBatteryManager.onConfigurationChanged();
        }
        //*/

        //*/ freeme.gouzhouping, 20170908. customize dismiss view.
        DismissViewButton btnMoreSettings = (DismissViewButton)mDismissView.findViewById(R.id.notification_settings);
        if (btnMoreSettings != null) {
            btnMoreSettings.setText(R.string.freeme_notification_settings_text);
        }
        //*/
    ...
    public void destroy() {
        ...
        //*/ freeme.gouzhouping, 20170908. show notification icon switch.
        mContext.getContentResolver().unregisterContentObserver(mNotificationObserver);
        //*/
    }
    ...
    public boolean onDraggedDown(View startingChild, int dragLengthY) {
        /*/ freeme. gouzhouping, 20170908. forbidden slide status bar when keyguard showing.
        if (hasActiveNotifications()) {
        /*/
        if (hasActiveNotifications() && !mNotificationPanel.isForibSlide()) {
        //*/
            EventLogTags.writeSysuiLockscreenGesture(
    ...
    //*/ freeme.zhiwei.zhang, 20170911. Navigation.
    private View.OnClickListener mCollapsableButtonClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private void updateNavigationBar(boolean navCollapsed) {
        if (!FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE) || mNavigationBarView == null) return;

        try {
            mWindowManagerService.updateNavigationBar(navCollapsed);
        } catch (RemoteException ex) {
            ex.printStackTrace();
            return;
        }

        mNavigationBarView.setVisibility(navCollapsed ? View.GONE : View.VISIBLE);
        //*/ freeme.gouzhouping, 20170920. show carrier label.
        mNotificationPanel.updateQSNavScrimVisibility(navCollapsed);
        //*/
    }

    private void collapseNavigationBar() {
        if (!FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) return;
        ...
        if ((mSystemUiVisibility & (View.SYSTEM_UI_FLAG_IMMERSIVE | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY)) == 0
            ...
            intent.putExtra(FreemeIntent.EXTRA_CHANGED_STATUS, true);
    ...
    private void launchFreemeAssistAction() {
        try {
            Intent freemevoiceintent = new Intent("com.freeme.voiceassistant.STARTFREEMEVOICE");
            freemevoiceintent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            freemevoiceintent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            freemevoiceintent.putExtra("mytarget", true);
            freemevoiceintent.setPackage("com.freeme.voiceassistant");
            mContext.startActivity(freemevoiceintent);
    ...
    //*/ freeme.gouzhouping, 20170622. show carrier label.
    public void updateCarrierVisibility(boolean isShow) {
        mCarrierLabel.setVisibility(isShow ? View.GONE : View.VISIBLE);
    }
    //*/
    ...
    public void updateShowNotifications() {
        ...
        if (isShow) {
            mIconController.showNotificationIconArea(true);
        } else {
