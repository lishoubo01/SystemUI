...
public class NavigationBarView extends LinearLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
       ...
       // MPlugin Navigation Bar creation and initialization
        ...
        //*/ freeme.zhiwei.zhang, 20170911. Navigation.
        mBarTransitions = new com.freeme.systemui.statusbar.FreemeNavigationBarTransitions(this);
        /*/
        ...
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            mButtonDisatchers.put(R.id.freeme_collapsable_bar, new ButtonDispatcher(R.id.freeme_collapsable_bar));
        }
        //*/
    }
    ...
    private void updateIcons(Context ctx, Configuration oldConfig, Configuration newConfig) {
        ...
        if (oldConfig.densityDpi != newConfig.densityDpi) {
            ...
            //*/ freeme.zhiwei.zhang, 20170713. Navigation.
            mCollapsableBarIcon = ctx.getDrawable(R.drawable.ic_sysbar_collapsable_bar);
            //*/
            /// M: BMW @{
            if (MultiWindowManager.isSupported()) {
    ...
    public void setNavigationIconHints(int hints, boolean force) {
        ...
        //*/ freeme.zhiwei.zhang, 20170713. Navigation.
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            getCollapsableButton().setImageDrawable(mCollapsableBarIcon);
        }
        //*/
        setDisabledFlags(mDisabledFlags, true);
    }
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        //*/ freeme.zhiwei.zhang, 20170911. Navigation.
        // add view flag config next version, always visible now.
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            getCollapsableButton().setVisibility(View.VISIBLE);
        }
        //*/
    ...
    */
    ...
    //*/ freeme.zhiwei.zhang, 20170911. Navigation.
    private Drawable mCollapsableBarIcon;
    public ButtonDispatcher getCollapsableButton() {
        return mButtonDisatchers.get(R.id.freeme_collapsable_bar);
    }
    //*/
}
