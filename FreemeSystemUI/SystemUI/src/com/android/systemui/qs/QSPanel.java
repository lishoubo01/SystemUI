...
import com.freeme.systemui.qs.QSDataUsageView;
...
public class QSPanel extends LinearLayout implements Tunable, Callback {
    ...
    private QSDataUsageView mQSDataUsageView;
    //*/
    ...
    public QSPanel(Context context, AttributeSet attrs) {
        ...
        //*/ freeme.gouzhouping, 20171101. data usage.
        mQSDataUsageView = new QSDataUsageView(context);
        addView(mQSDataUsageView);
        //*/
        ...
        //*/ freeme.gouzhouping. 20170830. brightness layout
        mMinHeight = getResources().getDimensionPixelSize(R.dimen.qs_panel_min_height);
        if (mTileLayout instanceof PagedTileLayout) {
            ((PagedTileLayout) mTileLayout).setBrightnessView(mBrightnessView);
        }
        mTileView = (View) mTileLayout;

        // fix #16946, fix tiles under seekbar can be touched
        View seekbar = (View) findViewById(R.id.freeme_brightness_seekbar);
    ...
    protected void addTile(final QSTile<?> tile, boolean collapsedView) {
        ...
        /*/ freeme.gouzhouping, 2017012. quick settings tile.
        r.tileView.init(click, longClick);
        /*/
        r.tileView.init(click, new View.OnClickListener() {
            public void onClick(View v) {
    ...
    public void setExpandHeight(int height) {
        mTileView.setClipBounds(new Rect(0, 0, mTileView.getWidth(), mTileView.getHeight() - (getMaxExpandHeight() - height)));
        mBrightnessView.setTranslationY((float) (height - getMaxExpandHeight()));
        mQSDataUsageView.setTranslationY((float) (height - getMaxExpandHeight()));
        invalidate();
    }
    ...
    //*/ freeme.gouzhouping, 20171101. data usage.
    public QSDataUsageView getQSDataUsageView() {
        return mQSDataUsageView;
    }
    //*/
}
