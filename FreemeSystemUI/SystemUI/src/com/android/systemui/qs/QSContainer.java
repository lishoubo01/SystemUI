...
public class QSContainer extends FrameLayout {
    ...
    public int getDesiredHeight() {
        if (isCustomizing()) {
            //*/ freeme.gouzhouping. 20170830. brightness layout
            int h = getHeight();
            return h > 0 ? h : getRootView().getHeight();
            /*/
            return getHeight();
            //*/
        }
    ...
    protected int calculateContainerHeight() {
        ...
        //*/ freeme.gouzhouping. 20170830. brightness layout
                : (int) (mQsExpansion * (heightOverride - getQsMinExpansionHeight()))
    ...
    private void updateQsState() {
        //*/ freeme.gouzhouping. 20170830. brightness layout
        boolean expandVisually = (mQsExpanded || !mKeyguardShowing || mHeaderAnimating) && !mQSDetail.isShowingDetail();
        /*/
    ...
    public void setQsExpansion(float expansion, float headerTranslation) {
        ...
        //*/ freeme.gouzhouping. 20170830. brightness layout
        if (!mHeaderAnimating) {
            setTranslationY(mKeyguardShowing ? (translationScaleY * getHeight()) : headerTranslation);
        }
