...
public class AirplaneModeTile extends QSTile<QSTile.BooleanState> {
    ...
    /*/
    private final AnimationIcon mEnable =
            new AnimationIcon(R.drawable.freeme_ic_qs_airplanemode_off2on,
                    R.drawable.freeme_ic_qs_airplanemode_tile_off);
    private final AnimationIcon mDisable =
            new AnimationIcon(R.drawable.freeme_ic_qs_airplanemode_on2off,
                    R.drawable.freeme_ic_qs_airplanemode_tile_on);
    //*/
