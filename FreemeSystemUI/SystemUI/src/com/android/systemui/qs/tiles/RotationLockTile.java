...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
    ...
    private final AnimationIcon mFreemeAutoToPortrait
            = new AnimationIcon(R.drawable.freeme_ic_qs_auto_rotation_to_animtor,
            R.drawable.freeme_ic_qs_auto_rotation_from);
    private final AnimationIcon mFreemePortraitToAuto
            = new AnimationIcon(R.drawable.freeme_ic_qs_auto_rotation_from_animtor,
            R.drawable.freeme_ic_qs_auto_rotation_to);
    //*/
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        //*/ freeme.gouzhouping, 20170908. replace the resources.
        state.icon = rotationLocked ? mFreemePortraitToAuto : mFreemeAutoToPortrait;
        //*/
