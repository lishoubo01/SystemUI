...
public class WifiTile extends QSTile<QSTile.SignalState> {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        if (!state.value) {
            ...
            /*/
            state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_wifi_off);
            //*/
            ...
            /*/
            state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_wifi_on);
            //*/
            ...
            /*/
            state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_wifi_not_disconnect);
            //*/
            state.label = r.getString(R.string.quick_settings_wifi_label);
        } else {
            /*/ freeme.gouzhouping, 20170908. replace the resources.
