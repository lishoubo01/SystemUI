...
public class HotspotTile extends QSTile<QSTile.AirplaneBooleanState> {
    ...
    protected void handleUpdateState(AirplaneBooleanState state, Object arg) {
        ...
        /*/
        state.icon = ResourceIcon.get(state.value ? R.drawable.freeme_ic_qs_hotshot_on :
                R.drawable.freeme_ic_qs_hotshot_off);
        //*/
        ...
        if (state.isAirplaneMode) {
            ...
            /*/
            state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_hotshot_off);
            //*/
        } else if (wasAirplane) {
            /*/ freeme.gouzhouping, 20170908. replace the resources.
