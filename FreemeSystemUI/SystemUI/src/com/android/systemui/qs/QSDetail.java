...
public class QSDetail extends LinearLayout {
    ...
    //*/ freeme.zhongkai.zhu. 20170830. optimize detail panel
    private Interpolator INTERPOLATOR = new PathInterpolator(0.33f, 0.0f, 0.67f, 1.0f);
    /*/
    ...
    private void handleShowingDetail(final QSTile.DetailAdapter adapter, int x, int y) {
        ...
        if (visibleDiff) {
            ...
            //*/ freeme.zhongkai.zhu. 20170830. optimize detail panel
            mHeader.animate().alpha((float) (showingDetail ? 0 : 1))
                    .setDuration(100)
                    .setInterpolator(INTERPOLATOR)
                    .setStartDelay(showingDetail ? 0 : 366)
                    .start();
            mQsPanel.animate().alpha((float) (showingDetail ? 0 : 1))
                    .setDuration(100)
                    .setInterpolator(INTERPOLATOR)
                    .setStartDelay(showingDetail ? 0 : 366).start();
            animate().alpha((float) (showingDetail ? 1 : 0))
                    .setDuration(366)
                    .setListener(listener)
                    .setStartDelay(showingDetail ? 100 : 0)
                    .setInterpolator(INTERPOLATOR)
                    .start();
            /*/
