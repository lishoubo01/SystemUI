...
public class StorageNotification extends SystemUI {
    ...
    //*/ freeme.chenming, 20171028. bugfix#19532, update storage entry
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_USER_SWITCHED.equals(action)) {
              updateUsbMassStorageNotification();
                ...
                //*/ freeme.chenming, 20171028. bugfix#19532, update storage entry
                mUserId = intent.getIntExtra(Intent.EXTRA_USER_HANDLE, UserHandle.myUserId());
    ...
    private Notification onVolumeMounted(VolumeInfo vol) {
        ...
        //*/ freeme.chenming, 20171028. bugfix#19532, update storage entry
        if (!vol.isVisibleForWrite(mUserId) && vol.isVisibleForRead(mUserId)) {
            return null;
        }
        //*/
