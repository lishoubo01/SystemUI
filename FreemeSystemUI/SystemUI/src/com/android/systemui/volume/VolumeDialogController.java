    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(AudioManager.VOLUME_CHANGED_ACTION)) {
                ...
                //*/ freeme.biantao, 20170921. Volume style(refresh locale resource).
                System.arraycopy(mContext.getResources().getStringArray(R.array.volume_stream_titles), 0,
                        mStreamTitles, 0, mStreamTitles.length);
                onGetStateW();
                //*/
