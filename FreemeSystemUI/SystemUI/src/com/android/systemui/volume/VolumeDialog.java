...
public class VolumeDialog implements TunerService.Tunable {
    ...
    private void updateFooterH() {
        ...
        /*/ freeme.gouzhouping, 20170907. use freeme theme.
    ...
    private void updateVolumeRowH(VolumeRow row) {
        ...
        /*/ freeme.chenming, 20170928. Remove zen effect to volume level
        final int vlevel = row.ss.muted && (isRingVibrate || !isRingStream && !zenMuted) ? 0
        //*/
        final int vlevel = row.ss.muted && (isRingVibrate || !isRingStream || isRingSilent) ? 0
        //*/
                : row.ss.level;
