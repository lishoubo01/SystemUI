...
public class Task {
    ...
    public boolean isTaskLocked(Context context) {
        if (key.baseIntent == null) {
            return false;
        }
        return LockTaskPreference.getInstance(context).isLocked(context,
                key.baseIntent.getComponent().flattenToShortString());
    }
    //*/
}
