...
public class RecentsView extends FrameLayout {
    ...
    public RecentsView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (RecentsDebugFlags.Static.EnableStackActionButton) {
            /*/ freeme.gouzhouping, 20171016. FreemeAppTheme clearall button.
            mStackActionButton = (TextView) inflater.inflate(R.layout.recents_stack_action_button,
                    this, false);
            /*/
//            mStackActionButton = (TextView) inflater.inflate(R.layout.freeme_recents_stack_action_button,
//                    this, false);
            //*/
...
//        /*/ freeme.gouzhouping, 20170619. show recents clearall button.
//        actionButtonRect.set(left, top, left + mStackActionButton.getMeasuredWidth(),
//                top + mStackActionButton.getMeasuredHeight());
//        //*/
//        Rect tmpRect = new Rect(mTaskStackView.mLayoutAlgorithm.mTaskRect);
//        int paddingLeft = (tmpRect.right - tmpRect.left - mStackActionButton.getMeasuredWidth()) / 2 + tmpRect.left;
//        actionButtonRect.set(paddingLeft, top, paddingLeft + mStackActionButton.getMeasuredWidth(),
//                top + mStackActionButton.getMeasuredHeight());
//        //*/
