...
public class BrightnessController implements ToggleSlider.Listener {
    ...
    private final Runnable mUpdateModeRunnable = new Runnable() {
        ...
        public void run() {
            if (mAutomaticAvailable) {
                ...
                //*/ freeme.gouzhouping. 20170908. brightness controller.
                mHandler.obtainMessage(MSG_SET_CHECKED, mAutomatic ? 1 : 0, 0 /* no use */).sendToTarget();
                //*/
            } else {
                //*/ freeme.gouzhouping. 20170908. brightness controller.
                mHandler.obtainMessage(MSG_SET_CHECKED, 0, 0 /* no use */).sendToTarget();
                /*/
    ...
    public void onChanged(ToggleSlider view, boolean tracking, boolean automatic, int value,
        ...
        //*/ freeme.gouzhouping. 20170908. brightness controller.
        if (!tracking) {
            if (mAutomaticAvailable && mAutomatic != automatic) {
